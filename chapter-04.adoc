...
Almost all the examples in this textbook are in the default namespace; we will look at namespaces further when we look at classes and objects in a later chapter.  However,

...
We also covered the `WebGrid` Helper when we discussed collections and databases.
...
You can see details of these with examples on the MSDN ...

// <<find good examples and pull one in here>>

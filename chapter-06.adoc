...
Go to your application's main administration panel and look for "Add ons". Click this, then page down until you find "Shared SQL Server"; click that service, and then add the Free level of support. This provides 20 MB of storage (something to keep in mind).

...
file is "sales.dat".
+
To complete this program, you'll need to save the file locally, then open the file and read from it. You will need to learn to read from a file and determine when the end of a file is reached. In psuedocode this is:
+
----
open file
read a line
while not EOF(file)
  process the line read before
  read the next line
close the file
+
